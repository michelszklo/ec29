...
SIOPS <- SIOPS %>% 
  mutate(desppessoal_pcapita = despsaude_pcapita * pct_desppessoal_desptotal / 100,
         ...
         desprecpropriosaude_pcapita = ifelse(desprecpropriosaude_pcapita<0,NA,desprecpropriosaude_pcapita),
...
SIOPS_out <- SIOPS %>% 
  ...
  select(c("cod_mun", "ano", "cod_uf", "UF", "nome_mun", "pop", "despsaude_pcapita", "desppessoal_pcapita", "despinvest_pcapita", "despmedicamentos_pcapita", "despservicoster_pcapita", "despexrecproprio_pcapita","desprecpropriosaude_pcapita", "pct_recproprios_ec29", "desptotalsaude_uf"))
