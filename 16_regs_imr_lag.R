...
write.xlsx2(df_table_all, file = "regs/results.xlsx" ,sheetName = "imr_lag",row.names = F,append = T)
...
ggsave("regs/imr_lag_all.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/imr_lag_all.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
...
ggsave("regs/imr_lag_below.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/imr_lag_below.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
...
ggsave("regs/imr_lag_above.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/imr_lag_above.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
