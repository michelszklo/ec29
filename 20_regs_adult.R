...
# April 2021
# 
# This scripts runs regressions for adult ospitalization and mortality
#
#
#######################################################################################################
...
write.xlsx2(df_table_all, file = paste0(dir,main_folder,output_file),sheetName = "adults_illdefTrend",row.names = F,append = T)
