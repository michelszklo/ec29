...
reduced_yearly_het_c <- function(outcome,var_name,df, df1_name, df2_name,transform,year_filter,y0,yf,ys,sample,below,weight,year_cap,label_size){
...
yearly_folder <- "yearly_reduced_form_dist_ec29_spending_abovebelow/"
...
for (i in c(1,3)){
  ...
  print(var_name)
  reduced_yearly_het_c(var,var_name,df, df1_name, df2_name,1,1998,-4,4,1,"log",below = below,weight = "peso_pop",year_cap = 2010) # ec29baseline
...
for (i in c(7,seq(15,21,1))){
  ...
  var_name <- var_map[i,2]
  print(var_name)
  reduced_yearly_het_c(var,var_name,df, df1_name, df2_name,1,1998,-8,14,2,"log2",below = below,weight = "peso_pop",year_cap = 2010) # ec29baseline
}
...
for (i in c(1,3)){
  ...
  var_name <- var_map[i,2]
  print(var_name)
  reduced_yearly_het_c(var,var_name,df, df1_name, df2_name,3,1998,-2000,1500,500,"level",below = below,weight = "peso_pop",year_cap = 2010) # ec29baseline
...
for (i in c(7,seq(15,21,1))){
  ...
  var_name <- var_map[i,2]
  print(var_name)
  reduced_yearly_het_c(var,var_name,df, df1_name, df2_name,3,1998,-1000,1000,250,"level2",below = below,weight = "peso_pop",year_cap = 2010) # ec29baseline
}
