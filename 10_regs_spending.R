...
write.xlsx2(df_table_all, file = "regs/results.xlsx" ,sheetName = "spending",row.names = F,append = T)
...
ggsave("regs/spending_all.png",
       plot = graph,
       device = "png",
       width = 10, height = 6.5,
       units = "in")
ggsave("regs/spending_all.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 6.5,
       units = "in")
...
ggsave("regs/spending_below.png",
       plot = graph,
       device = "png",
       width = 10, height = 6.5,
       units = "in")
ggsave("regs/spending_below.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 6.5,
       units = "in")
...
ggsave("regs/spending_above.png",
       plot = graph,
       device = "png",
       width = 10, height = 6.5,
       units = "in")
ggsave("regs/spending_above.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 6.5,
       units = "in")
