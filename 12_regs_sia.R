...
write.xlsx2(df_table_all, file = "regs/results.xlsx" , sheetName = "sia", row.names = F, append = T)
...
ggsave("regs/sia_all.png",
       plot = graph,
       device = "png",
       width = 10, height = 7,
       units = "in")
ggsave("regs/sia_all.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 7,
       units = "in")
...
ggsave("regs/sia_below.png",
       plot = graph,
       device = "png",
       width = 10, height = 7,
       units = "in")
ggsave("regs/sia_below.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 7,
       units = "in")
...
ggsave("regs/sia_above.png",
       plot = graph,
       device = "png",
       width = 10, height = 7,
       units = "in")
ggsave("regs/sia_above.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 7,
       units = "in")
