...
# April 2021
# 
# This scripts runs regressions for public Infant Adult rates - LAGGED EFFECTS
#
#
#######################################################################################################
...
write.xlsx2(df_table_all, file = "regs/results.xlsx" ,sheetName = "amr_lag",row.names = F,append = T)
...
ggsave("regs/amr_lag_all.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/amr_lag_all.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
...
ggsave("regs/amr_lag_below.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/amr_lag_below.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
...
ggsave("regs/amr_lag_above.png",
       plot = graph,
       device = "png",
       width = 10, height = 12,
       units = "in")
ggsave("regs/amr_lag_above.pdf",
       plot = graph,
       device = "pdf",
       width = 10, height = 12,
       units = "in")
